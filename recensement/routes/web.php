...
Route::prefix('concorde/admin')->group(function(){
    ...
    Route::get('/statistique', [AdminController::class, 'statistique'])->name('admin.stats')->middleware('auth:admin');
    ...
    Route::get('/ajouter', [SuperController::class, 'addAdmin'])->name('super.add')->middleware('auth:admin');

    Route::get('/admins', [SuperController::class, 'adminAxe'])->name('super.adminList')->middleware('auth:admin');
    Route::get('/axes', [SuperController::class, 'axeList'])->name('super.axeListe')->middleware('auth:admin');
});
